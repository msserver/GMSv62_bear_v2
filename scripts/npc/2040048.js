...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.teachSkill(5121000,20,20); //Maple Warrior - For a set period of time, the stats of every member in your party will be boosted.
			...
			cm.teachSkill(5221000,20,20); //Maple Warrior - For a set period of time, the stats of every member in your party will be boosted.
